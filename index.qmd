...
## [Is it possible that we can digitalize these decisions?]{.r-fit-text}
...
## {.smaller background-image="figures/your-time.png" background-size="65%" background-position="50% 40%"}
